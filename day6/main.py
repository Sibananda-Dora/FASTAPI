...
def update_post_partial(post_id: int, post_data: PostUpdate, db: Annotated[Session, Depends(get_db)]):
    ...
    #exclude_unset lets us update onlt the selected not making the rest as dfault set values
...
#up we solved the httperror but we didnt handled the errors which happens if string pop up instead of int or what expected
